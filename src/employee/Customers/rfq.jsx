...
import EmpQuotesSidebar from "../components/empSidebar";
import AddBend from "../components/Addbend";
export default function EmpCustomerRFQ() {
  ...
  const handleShow = (quote, id) => {
    console.log("asdfghjkhgfdsadfghjhgfdsasdfghjhgfdsadfghjhgfdsdfghjkljhgfdsa")
    setSelectedQuote(quote);
    setSelectedPartId(id);
    setModalShow5(true); 
    console.log("2323454545445")
  };
  const getDimension = [
  ...
  const handleClose = () => setModalShow5(false);
