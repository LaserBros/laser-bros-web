        ...
        <React.Fragment>
            <Card>
                <CardHeader className="d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <Button as={Link} to="/orders" className="d-inline-flex align-items-center justify-content-center">Back To Orders</Button>
                </CardHeader>
                <CardBody>
                    <Row>
                        ...
                        <div className="orders-card">
                               ...
                               <div className="d-flex align-items-center mb-3"><label>Due Date: </label>   <span>6-14-24</span></div>
                               <div className="d-flex align-items-center mb-3"><label>Order Amount: </label>  <span>$100</span></div>
                               <div className="d-flex align-items-center"><label>Status: </label>  <span className="statusnew fw-medium">Paid</span></div>
                            </div>
                        </Col>
                    ...
                    <div className="orders-shipping d-flex align-items-center justify-content-between flex-wrap">
                        <div className="d-inline-flex align-items-center gap-2 my-1">
                            ...
                            <span className="badgestatus" style={{backgroundColor:"#2A5C17"}}>SB0036</span>
                        </div>
                        <div className="d-inline-flex align-items-center gap-2 my-1">
                            <b>Shipping:</b>
                                                            ...
                                                            <div className="list-checkboxes  d-inline-flex gap-3">
                                                                {wo.labels.map((label,index) => (
                                                                    <div className="custom-checkbox-container text-center" key={label}>
                                                                        <label key={index}  className="custom-label" htmlFor={`${label}${wo.id}`} style={getLabelsColor(wo.materials)}>{label}</label>
