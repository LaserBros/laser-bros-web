...
const customStyles = {
  control: (provided) => ({
    ...
    borderColor: "rgba(0,0,0,0.10)", // Custom border color
    borderRadius: "0.375rem", // Rounded corners
    padding: "0px", // Padding around the select control
  ...
  option: (provided, state) => ({
    ...
    backgroundColor: state.isSelected
      ...
      : state.isFocused
      ? "#e9ecef"
      : "#ffffff", // Change background color on focus or selection
    color: state.isSelected ? "#ffffff" : "#333333", // Text color
    padding: "10px", // Padding for options
    cursor: "pointer",
  }),
  multiValue: (provided) => ({
    ...provided,
    backgroundColor: "#4f8cca", // Background for selected items
    borderRadius: "20px", // Rounded edges for selected values
  ...
  multiValueRemove: (provided) => ({
    ...
    ":hover": {
      backgroundColor: "#dc3545", // Red background on hover
      color: "#fff",
    },
  }),
  dropdownIndicator: (provided) => ({
    ...provided,
    color: "#000", // Custom color for the dropdown arrow
    ":hover": {
      color: "#0056b3", // Change arrow color on hover
    },
  }),
  indicatorSeparator: () => ({
    display: "none", // Remove the separator line between the dropdown indicator and select control
  }),
};
