        ...
        try {
          ...
          setForm({
            ...
            product_image_hover_url:
              response.data.product_image_hover_url || "",
      ...
      <Card>
        ...
        <CardBody>
          <Form onSubmit={handleSubmit} noValidate>
            ...
            >
              ...
              {imagePreview.product_image_url_preview && (
                <div className="fileuploadedgrid mt-2">
                  <Image
                    src={imagePreview.product_image_url_preview}
                    alt="Product Image Preview"
                    fluid
                    style={{ maxHeight: "200px", marginRight: "10px" }}
                  />
                  <CloseButton
                    onClick={() => handleRemoveImage("product_image_url")}
                  />
                </div>
              )}
            </Form.Group>
            ...
            <Form.Group
              className="form-group mb-3"
              controlId="product_image_hover_url"
            >
              ...
              <Form.Control
                ...
                accept="image/*"
                onChange={(e) =>
                  handleImageChange(e, "product_image_hover_url")
                }
                className="py-85rem px-4"
              ...
              {imagePreview.product_image_hover_url_preview && (
                <div className="fileuploadedgrid mt-2">
                  <Image
                    src={imagePreview.product_image_hover_url_preview}
                    alt="Product Hover Image Preview"
                    fluid
                    style={{ maxHeight: "200px", marginRight: "10px" }}
                  />
                  <CloseButton
                    onClick={() => handleRemoveImage("product_image_hover_url")}
                  />
                </div>
              )}
            </Form.Group>
