                            ...
                            <tbody>
                                {data.map(row => (
                                    <React.Fragment key={row.id}>
                                        <tr>
                                        <td className='text-nowrap'><Link to="/rfqs/rfqs-detail" className="workorders"><b>WO# {row.wo}</b></Link></td>
                                            ...
                                            <td className="text-nowrap"><div className="d-inline-flex align-items-center gap-3"><Link className="btnaccept"><Icon icon="icon-park-outline:check-one"/>Accept</Link><Link className="btnreject"><Icon icon="ion:close-circle-outline"/>Reject</Link></div></td>
