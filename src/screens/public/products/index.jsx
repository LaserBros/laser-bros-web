  ...
  return (
    <React.Fragment>
                      ...
                      <Col key={index} xl={3} lg={4} md={6} sm={6}>
                        <div className="Productmain_box">
                          <div className="Product_img">
                            <Image
                              className="img_hover"
                              src={product.product_image_hover_url}
                              alt=""
                            />
                            <Image
                          ...
                          <h4>
                            <Link to="#">{product.product_title}</Link>
                          </h4>
                          <p>
                            <Button
                              onClick={() =>
      ...
      <Modal
        ...
        className="product_modal modal-custom "
        size="lg"
        scrollable
      >
        {/* <Button
        ...
        ></Button> */}
        <ModalHeader>
          <ModalTitle className="d-flex align-items-center justify-content-between w-100">
          <h3 className="main_heading mb-0">{modal.product_title}</h3>
          <Button
        ...
        <Modal.Body>
          ...
          <div
            dangerouslySetInnerHTML={{ __html: modal.product_description }}
          />

          <Button
            onClick={() =>
              DownloadDxf(modal.product_title, modal.product_dxf_url, modal._id)
            }
            disabled={disabledBtn}
          >
