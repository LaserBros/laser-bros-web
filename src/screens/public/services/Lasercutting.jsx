                    ...
                    <Row className="align-items-center">
                        <Col lg={6}>
                            <div className="banner-content">
                                <h1 className="text-start"><span>Laser Cutting<img src={shape1} className="img-fluid w-100" alt="" /></span> Service.</h1>
                                <p className="text-start">We use two fiber lasers to handle our cutting, a 3kw and 12kw. With these machines we can process a wide variety of metals (no wood or plastics with these machines). Visit our resource page to learn more about the laser cutting process, limitations, & capacities.</p>
                            ...
                            <div className="get-quote-content">
                                ...
                                <div className="features-content-box">
                                    ...
                                    <div className="content">
                                        <p>Upload your DXF file to the platform. Make sure your DXF is of the part only (no drawing boxes or text). Also, don’t upload “nested” DXF files since this can display a more expensive price!</p>
                                    </div>
                                </div>
                                <div className="features-content-box">
                                    <div className="feature-icon">
                                    ...
                                    <div className="content">
                                        <p>Select your material, thickness, and quantity. All three of these variables will affect the price you see. Note that some materials have size limits. This doesn’t always mean they can’t be made- it just means we have to review and confirm that we can make it!</p>
                                    </div>
                                </div>
                                <div className="features-content-box">
                                    <div className="feature-icon">
                                    ...
                                    <div className="content">
                                        <p>Login & fill out your address information to see current shipping rates.</p>
                                    </div>
                                </div>
                                <div className="features-content-box">
                                    <div className="feature-icon">
                                    ...
                                    <div className="content">
                                        <p>Complete payment and we’ll get to work! Most orders are cut in 2-5 days!</p>
                                    </div>
                                </div>
                            </div>
                        </Col>
