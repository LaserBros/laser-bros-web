...
export default function Home() {
  ...
  const services = [
    { id: 1, title: 'Laser Cutting', leadTime: 'Typical lead time 2-5 days', icon: icon1, img: serviceimg1, link: '/laser-cutting' },
    { id: 2, title: 'Bending', leadTime: 'Typical lead time +2-3 days', icon: icon2, img: serviceimg2, link: '/bending' }
      ...
      <section className="banner-home">
        <Container>
          <div className="banner-content">
            <h1>Here to Support The <span>American <img src={shape1} className="img-fluid" alt="" /></span> Innovator</h1>
            <p>On Demand Sheet Metal Services. Old-school customer service combined with new-school technology.</p>
            ...
            <p className="banner-sm-text">So what makes Laser Bros any different from these other on demand laser cutting services? Mission: <b>To Support the American Innovator.</b> This is why we do what we do. The American innovator can be anyone; an entrepreneur launching their product from their garage, a group of dudes building a project car, or a company building something that’ll get launched into space. They’re all innovating in their own way. We want to be a means to that innovation, a resource to remove limitations around what can be built.</p>
            <div className="banner-upload-file mb-2">
          ...
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="services-img">
                ...
                <img src={getCurrentImage()} className="img-fluid rounded-circle" alt="Service" />
              </div>
            </Col>
            <Col lg={6}>
              <div className="services-content">
                <div className="heading mb-5">
                  <h2>Our Services</h2>
                  <p className="max-width-470">Some of the services we offer.</p>
                </div>
                <Row>
            ...
            <Col lg={6} className="ps-lg-4">
              <div className="get-quote-content">
                <div className="heading mb-4">
                  ...
                  <p>Upload your DXF(s) for an instant quote. You don’t even have to create an account to try it out!</p>
                </div>
                ...
                <div className="features-content-box">
                  ...
                  <div className="content">
                    <h3>Checkout & Pay</h3>
                    <p>Pay for your parts directly on the platform. No hidden fees, and no waiting.</p>
                  </div>
                </div>
              </div>
            </Col>
            ...
            <Col lg={6}>
              <div className="get-quote-content">
                <div className="heading mb-4">
                  ...
                  <p>Don’t wait weeks for your parts. We work hard to make sure your parts get to you as fast as possible!</p>
                </div>
                <div className="features-content-box">
                  <div className="feature-icon">
                  ...
                  <div className="content">
                    ...
                    <p>We do this to be completely transparent with our pricing. No baked in shipping costs disguised as “Free-shipping”.</p>
                  </div>
                </div>
                <div className="features-content-box">
                  <div className="feature-icon">
                  ...
                  <div className="content">
                    ...
                    <p>We offer overnight shipping options for orders that require extra fast delivery!</p>
                  </div>
                </div>
                <div className="features-content-box">
                  <div className="feature-icon">
                  ...
                  <div className="content">
                    ...
                    <p>You’re more than welcome to pick up your parts in person at our Graham, NC facility!.</p>
                  </div>
                </div>
                {/* <div className="features-content-box">
                  <div className="feature-icon">
          ...
          <Slider {...settings}>
            <div className="testimonials-grid">
              <div className="userinfo">
                <img src={user1} className="rounded-circle img-fluid mx-auto" alt="" />
            ...
            <div className="testimonials-grid">
              <div className="userinfo">
                <img src={user2} className="rounded-circle img-fluid mx-auto" alt="" />
                <h3>Donald Jones</h3>
                <p>April 6, 2024</p>
                <div className="testimonial-rating">
                  <Icon icon="ic:round-star" />
